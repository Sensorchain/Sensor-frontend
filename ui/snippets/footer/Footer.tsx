  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      iconSize: '18px',
      text: 'Github',
      url: 'https://github.com/Sensorchain/',
    },
    {
  ...
  const renderProjectInfo = React.useCallback((gridArea?: GridProps['gridArea']) => {
    return (
      <Box gridArea={ gridArea }>
        <Link fontSize="xs" href="https://www.sensorprotocol.com/">sensorprotocol.com</Link>
        <Text mt={ 3 } fontSize="xs">
          Sensor Protocol Transforming the frontier where Blockchain, AI and Spatial computing converge. Join us in our missing to abstract the physical and digital realms
        </Text>
